...
class Ui_Dialog(object):
    ...
    def setPics(self):
        self.ImageDraw.setPixmap(QtGui.QPixmap("turn_test.png"))

    def setupUi(self, Dialog):
        Dialog.setObjectName("Dialog")
        Dialog.resize(705, 660)
        Dialog.setFixedSize(705, 660)
        Dialog.setAcceptDrops(False)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("logo.jpg"),
        ...
        self.labelSendArduino.setGeometry(QtCore.QRect(30, 470, 481, 40))
        font = QtGui.QFont()
        ...
        self.btnSendData.setGeometry(QtCore.QRect(30, 510, 100, 40))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.ImageDraw.setGeometry(QtCore.QRect(370, 480, 300, 150))
        self.ImageDraw.setFocusPolicy(QtCore.Qt.NoFocus)
        self.ImageDraw.setText("")
        self.ImageDraw.setPixmap(QtGui.QPixmap(""))
        self.ImageDraw.setObjectName("ImageDraw")

        self.ButtonPredict.clicked.connect(self.setPics)
